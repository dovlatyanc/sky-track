...
export function Header() {
	...
	return (
		<div className='xs:hidden bg-card sm:px-mini-element xs:flex-col xs:pb-4 absolute top-0 lg:top-7 left-1/2 z-10 flex w-full lg:w-4/12 -translate-x-1/2 items-center justify-between rounded-b-xl lg:rounded-xl p-2 px-5 sm:rounded-lg xl:relative xl:top-0 xl:mb-5 xl:w-full'>
